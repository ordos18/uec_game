...
HD_PWD='C:/Users/Puszek/Desktop/Nowe_coS/project_1/project_1.runs/system_VGA_SQUAREDRAW_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_VGA_SQUAREDRAW_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_VGA_SQUAREDRAW_0_1.tcl
