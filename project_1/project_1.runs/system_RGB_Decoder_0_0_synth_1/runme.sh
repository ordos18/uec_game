...
HD_PWD='C:/Users/Puszek/Desktop/Nowe_coS/project_1/project_1.runs/system_RGB_Decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_RGB_Decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_RGB_Decoder_0_0.tcl
