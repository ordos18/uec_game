...
HD_PWD='C:/Users/Puszek/Desktop/Nowe_coS/project_1/project_1.runs/system_Video_Background_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Video_Background_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Video_Background_0_0.tcl
